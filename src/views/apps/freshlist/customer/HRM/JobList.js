...
import { HRM_JOBLIST, HRM_DELETE_JOB } from "../../../../../ApiEndPoint/Api";
        ...
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.jobCategory?.name}</span>
                </div>
              </div>
            );
          },
  ...
  async Apicalling(id, db) {
    ...
    await _Get(HRM_JOBLIST, db, id)
      .then(res => {
        ...
        let userHeading = JSON.parse(localStorage.getItem("JobList"));
