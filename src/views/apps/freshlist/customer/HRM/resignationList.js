...
import { Eye, ChevronDown, Edit, Trash2, CornerDownLeft } from "react-feather";
...
class ResignationList extends React.Component {
              ...
              <div className="actions cursor-pointer text-center">
                    ...
                    <Eye
                      ...
                      onClick={() =>
                        this.props.history.push({
                          pathname: `/app/ajgroup/HRM/HRMAdminForms/resignationVIEW/${params.data?._id}`,
                          state: params.data,
                        })
                      }
                    />
                ...
                {this.state.InsiderPermissions.Edit && (
                  <Edit
                    ...
                    onClick={() =>
                      this.props.history.push({
                        pathname: `/app/ajgroup/HRM/HRMAdminForms/resignationEDIT/${params.data?._id}`,
                        state: params.data,
                      })
                    }
                  />
        ...
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.resignationDate}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.lastWorkingDay}</span>
                </div>
              </div>
            );
          },
  ...
  async Apicalling(id, db) {
    ...
    await _Get(VIEW_RESIGNATION, db, id)
      .then(res => {
        this.setState({ Loading: false });
        console.log(res?.Resignation);

        if (res?.Resignation) {
          this.setState({ rowData: res?.Resignation });
        }
        this.setState({ AllcolumnDefs: this.state.columnDefs });
        this.setState({ SelectedCols: this.state.columnDefs });

        let userHeading = JSON.parse(localStorage.getItem("Resignationlist"));
  ...
  async componentDidMount() {
    const InsidePermissions = CheckPermission("Resignation");
                      ...
                      <Button
                        ...
                        onClick={() =>
                          history.push(
                            ...
                            "/app/ajgroup/HRM/HRMAdminForms/resignationForm"
                          )
                        }
                      >
