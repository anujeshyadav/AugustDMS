...
class Attenreport extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      columnDefs: [
        ...
        //         <div>
        //           <Badge color="primary">
        //             {(params.data?.grandTotal - params.data?.amount).toFixed(2)}
        //           </Badge>
        //         </div>
        //       </div>
        //     );
  ...
  async Apicalling(id, db) {
    ...
    await createOrderhistoryview(id)
      .then(res => {
        ...
        if (res?.orderHistory) {
          ...
          this.setState({ rowData: completed });
          this.setState({ rowAllData: completed });
        }
        this.setState({ AllcolumnDefs: this.state.columnDefs });
        this.setState({ SelectedCols: this.state.columnDefs });

        let userHeading = JSON.parse(
          localStorage.getItem("reportAttendanceList")
        );
    ...
    //     let userHeading = JSON.parse(localStorage.getItem("reportAttendanceList"));
    //     if (userHeading?.length) {
    //       this.setState({ columnDefs: userHeading });
    //       // this.gridApi.setColumnDefs(userHeading);
    //       this.setState({ SelectedcolumnDefs: userHeading });
