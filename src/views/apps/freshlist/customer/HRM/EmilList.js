...
class EmilList extends React.Component {
              ...
              <div className="actions cursor-pointer text-center">
                    ...
                    <Eye
                      ...
                      onClick={() =>
                        this.props.history.push({
                          pathname: `/app/ajgroup/HRM/HrmOfferletr/OfferltrView/${params.data?._id}`,
                          state: params.data,
                        })
                      }
                    />
                ...
                {this.state.InsiderPermissions.Edit && (
                  <Edit
                    ...
                    onClick={() =>
                      this.props.history.push({
                        pathname: `/app/ajgroup/HRM/HrmOfferletr/OfferletrEdit/${params.data?._id}`,
                        state: params.data,
                      })
                    }
                  />
  ...
  LookupviewStart = () => {
    ...
    if (this.state.createAdvence) {
      this.setState({ createAdvence: false });
    }
  };
  ...
  async componentDidMount() {
    const InsidePermissions = CheckPermission("Event");
      ...
      <>
        <>
          <Card>
            <Row style={{marginLeft:'3px',marginRight:'3px'}}>
              ...
              <Col xl="3" lg="3" md="3" style={{ marginTop: "20px" }}>
              ...
              <Col xs="6" xl="1" lg="1" md="1" style={{ marginTop: "20px" }}>
        ...
        >
          <ModalHeader toggle={this.LookupviewStart}>
            {" "}
            {this.state.createAdvence ? <>Add EMI</> : <>Change Fileds</>}{" "}
          </ModalHeader>
          <ModalBody className="modalbodyhead">
            {this.state.createAdvence ? (
              <>
