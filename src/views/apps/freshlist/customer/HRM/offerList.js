...
class OfferList extends React.Component {
        ...
        // parameter's : name,email,mobileNo
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.name?.name}</span>
                </div>
              </div>
            );
          },
  ...
  async Apicalling(id, db) {
    ...
    await _Get(Hrm_OfferList, db, id)
      .then((res) => {
        ...
        let userHeading = JSON.parse(localStorage.getItem("offerletterList"));
  ...
  async componentDidMount() {
    const InsidePermissions = CheckPermission("Offer Letter");
