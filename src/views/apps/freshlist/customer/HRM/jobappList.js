...
class JobappList extends React.Component {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            ...
            return params.data?.checkStatus == "Hired" ? (
              <div className="cursor-pointer text-center">
                {params.data?.checkStatus}
              </div>
            ) : params.data?.checkStatus == "Rejected" ? (
              <div className="cursor-pointer text-center">
                {params.data?.checkStatus}
              </div>
            ) : (
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.job?.jobTitle}</span>
                </div>
              </div>
            );
          },
  ...
  async Apicalling(id, db) {
    ...
    await _Get(Hrm_AppyList, db, id)
      .then((res) => {
        ...
        let userHeading = JSON.parse(localStorage.getItem("JobAppliedList"));
  ...
  async componentDidMount() {
    const InsidePermissions = CheckPermission("Job Applied/ Result");
