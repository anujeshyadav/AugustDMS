...
class HolidayList extends React.Component {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.shiftName}</span>
                </div>
              </div>
            );
          },
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.fromTime}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.lateByTime}</span>
                </div>
              </div>
            );
          },
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.shortByTime}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.totalHours}</span>
                </div>
              </div>
            );
          },
  ...
  handleWorkingHours = async (e) => {
    ...
    let payload = {
      ...
      shiftName: workingHours?.shiftName,
      database: userData?.database,
    };
    if (this.state.EditOne) {
      await _Put(Working_Hours_UpdateOne, workingHours?._id, payload)
        .then((res) => {
  ...
  async Apicalling(id, db) {
    ...
    await _Get(Working_Hours_get, db)
      .then((res) => {
        console.log(res?.WorkingHours);
        this.setState({ Loading: false });

        if (res?.WorkingHours?.length > 0) {
          this.setState({ rowData: res?.WorkingHours });
        }
        this.setState({ AllcolumnDefs: this.state.columnDefs });
        this.setState({ SelectedCols: this.state.columnDefs });

        let userHeading = JSON.parse(localStorage.getItem("shiftList"));
  ...
  async componentDidMount() {
    const InsidePermissions = CheckPermission("Shift List");
  ...
  runthisfunction(id) {
    swal("Warning", "Sure You Want to Delete it", {
      ...
      switch (value) {
        case "delete":
          _Delete(Working_Hours_DeleteOne, id)
            .then((res) => {
      ...
      <>
        ...
        <Modal
          ...
          <ModalHeader toggle={this.LookupviewStart}>
            {this.state.AddShift ? <>Add Shift</> : <>Change Fileds</>}
          </ModalHeader>
                  ...
                  <CardBody>
                    <Form onSubmit={this.handleWorkingHours}>
                      <Row>
                        <Col md={12}>
                          <FormGroup>
                            ...
                            <Input
                              ...
                              name="shiftName"
                              id="shiftName"
                              value={this.state.workingHours.shiftName}
                              onChange={(e) => {
                                const { name, value } = e.target;
                                const inputPan = value;
                        ...
                        <Col md={6}>
                          <FormGroup>
                            <Label htmlFor="fromTime">In Time:</Label>
                            <Input
                              required
                              type="time"
                              name="fromTime"
                              id="fromTime"
                              value={this.state.workingHours.fromTime}
                        ...
                        <Col md={6}>
                          <FormGroup>
                            ...
                            <Input
                              ...
                              name="toTime"
                              id="toTime"
                              value={this.state.workingHours.toTime}
                              onChange={this.handleWorkingHoursChange}
                            />
                          </FormGroup>
                        </Col>
                        ...
                        <Col md={6}>
                          <FormGroup>
                            ...
                            <Input
                              ...
                              name="lateByTime"
                              id="lateByTime"
                              value={this.state.workingHours.lateByTime}
                              onChange={this.handleWorkingHoursChange}
                            />
                          </FormGroup>
                        </Col>
                        <Col md={6}>
                          <FormGroup>
                            ...
                            <Input
                              ...
                              name="shortByTime"
                              id="shortByTime"
                              value={this.state.workingHours.shortByTime}
                              onChange={this.handleWorkingHoursChange}
                            />
                          </FormGroup>
                        </Col>
