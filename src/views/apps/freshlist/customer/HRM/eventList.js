...
import { _Put, _Delete, _GetList } from "../../../../../ApiEndPoint/ApiCalling";
import {
...
import { Hrm_OfferList, Hrm_OfferDelete } from "../../../../../ApiEndPoint/Api";
...
class EventList extends React.Component {
  ...
  async Apicalling(id, db) {
    ...
    await _GetList(Hrm_OfferList, id, db)
      .then(res => {
        this.setState({ Loading: false });

        if (res?.OfferLetter) {
          this.setState({ rowData: res?.OfferLetter });
        }
        this.setState({ AllcolumnDefs: this.state.columnDefs });
        this.setState({ SelectedCols: this.state.columnDefs });

        let userHeading = JSON.parse(localStorage.getItem("EventList"));
