...
import { Hrm_TrainDelete, Hrm_TrainList } from "../../../../../ApiEndPoint/Api";
...
class TrainingList extends React.Component {
              ...
              <div className="actions cursor-pointer text-center">
                    ...
                    <Eye
                      ...
                      onClick={() =>
                        this.props.history.push({
                          pathname: `/app/ajgroup/HRM/HrmTraining/trainingView/${params.data?._id}`,
                          state: params.data,
                        })
                      }
                    />
                ...
                {this.state.InsiderPermissions.Edit && (
                  <Edit
                    ...
                    onClick={() =>
                      this.props.history.push({
                        pathname: `/app/ajgroup/HRM/HrmTraining/trainingEdit/${params.data?._id}`,
                        state: params.data,
                      })
                    }
                  />
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.employee?.length} Candidate</span>
                </div>
              </div>
            );
          },
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.trainingType}</span>
                </div>
              </div>
            );
          },
        ...
        //  parameter's : branch,trainer,employee,trainingType,trainingCost,startDate,endDate,description
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.trainingCost}</span>
                </div>
              </div>
            );
          },
  ...
  async Apicalling(id, db) {
    ...
    await _Get(Hrm_TrainList, db, id)
      .then((res) => {
        this.setState({ Loading: false });
        if (res?.Training) {
          this.setState({ rowData: res?.Training });
        }
        this.setState({ AllcolumnDefs: this.state.columnDefs });
        this.setState({ SelectedCols: this.state.columnDefs });

        let userHeading = JSON.parse(localStorage.getItem("trainingList"));
  ...
  async componentDidMount() {
    const InsidePermissions = CheckPermission("Training");
