...
import { _GetListData } from "../../../../../ApiEndPoint/ApiCalling";
import {
...
import {
  Incentive_DELETE_Incentive,
  Incentive_View_incentive,
...
class IncenList extends React.Component {
                    ...
                    <Edit
                      ...
                      onClick={() => {
                        ...
                        this.props.history.push({
                          pathname: `/app/ajgroup/HRM/TCPA/incenform/${params.data?._id}`,
                          // pathname: `/app/ajgroup/HRM/incentEdit/${params.data?._id}`,
                          state: params.data,
                        });
                      }}
                    />
        ...
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.employeeName?.Pan_No}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.rule?.rule}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.incentiveFund}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.targetAssign}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.targetAchievement}</span>
                </div>
              </div>
            );
          },
  ...
  async Apicalling(id, db) {
    ...
    await _GetListData(Incentive_View_incentive, db)
      .then(res => {
        this.setState({ Loading: false });
        console.log(res.Incentive);
        if (res?.Incentive) {
          this.setState({ rowData: res?.Incentive });
        }
