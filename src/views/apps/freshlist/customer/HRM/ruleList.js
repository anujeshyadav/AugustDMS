...
import {
  VIEW_RULE_CREATION,
  DELETE_RULE_CREATION,
} from "../../../../../ApiEndPoint/Api";
import { _GetList, _Delete } from "../../../../../ApiEndPoint/ApiCalling";
...
class RuleList extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      columnDefs: [
              ...
              <div className="actions cursor-pointer">
                    ...
                    <Eye
                      ...
                      onClick={() =>
                        this.props.history.push({
                          pathname: `/app/ajgroup/HRM/Setrules/viewrules/${params.data?._id}`,
                          state: params.data,
                        })
                      }
                    />
                ...
                {this.state.InsiderPermissions.Edit && (
                  <Edit
                    ...
                    onClick={() =>
                      this.props.history.push({
                        pathname: `/app/ajgroup/HRM/Setrules/editrules/${params.data?._id}`,
                        state: params.data,
                      })
                    }
                  />
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.typeValue}</span>
                </div>
              </div>
            );
          },
        ...
        //                 <div>
        //                     <span>{params.data?.inputType}</span>
        //                 </div>
        //             </div>
        //         );
        //     },
        ...
        //             <div className="d-flex align-items-center cursor-pointer">
        //                 <div>
        //                     <span>{params.data?.loanType}</span>
        //                 </div>
        //             </div>
        //         );
        //     },
        ...
        //             <div className="d-flex align-items-center cursor-pointer">
        //                 <div>
        //                     <span>{params.data?.bonusType}</span>
        //                 </div>
        //             </div>
        //         );
        //     },
        ...
        //             <div className="d-flex align-items-center cursor-pointer">
        //                 <div>
        //                     <span>{params.data?.durationType}</span>
        //                 </div>
        //             </div>
        //         );
        //     },
  ...
  async Apicalling(id, db) {
    ...
    await _Get(VIEW_RULE_CREATION, db, id)
      .then((res) => {
        console.log(res);
        this.setState({ Loading: false });

        if (res?.Rule) {
          this.setState({ rowData: res?.Rule });
        }
        this.setState({ AllcolumnDefs: this.state.columnDefs });
        this.setState({ SelectedCols: this.state.columnDefs });

        let userHeading = JSON.parse(localStorage.getItem("RuleLists"));
  ...
  async componentDidMount() {
    const InsidePermissions = CheckPermission("Rules");
  ...
  runthisfunction(id) {
    swal("Warning", "Sure You Want to Delete it", {
      ...
      switch (value) {
        case "delete":
          _Delete(DELETE_RULE_CREATION, id)
            .then((res) => {
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        onClick={() =>
                          history.push(
                            // "/app/ajgroup/HRM/Payroll/payslipform"
