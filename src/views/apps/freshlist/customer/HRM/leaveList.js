...
class LeaveList extends React.Component {
                    ...
                    <Eye
                      ...
                      onClick={() =>
                        this.props.history.push({
                          pathname: `/app/ajgroup/HRM/Time-sheet/leaveviewform/${params.data?._id}`,
                          state: params.data,
                        })
                      }
                    />
...

        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.leaveType}</span>
                </div>
              </div>
            );
          },
...

        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.noOfYearly}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.noOfmonthly}</span>
                </div>
              </div>
            );
          },
  ...
  async Apicalling(id, db) {
    ...
    await _Get(HRM_VIEW_LEAVE, db)
      .then(res => {
        console.log(res?.Leave);
        this.setState({ Loading: false });
        if (res?.Leave) {
          this.setState({ rowData: res?.Leave });
        }
  ...
  async componentDidMount() {
    const InsidePermissions = CheckPermission("Add Leave");
