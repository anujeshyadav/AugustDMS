...
import { Hrm_SkillList, Hrm_SkillDelete } from "../../../../../ApiEndPoint/Api";
...
class practiceList extends React.Component {
                    ...
                    <Eye
                      ...
                      onClick={() =>
                        this.props.history.push({
                          pathname: `/app/ajgroup/HRM/HrmPractskill/PracticsView/${params.data?._id}`,
                          state: params.data,
                        })
                      }
                      // /app/ajgroup/HRM/HrmPractskill/PracticsView/
                    />
                  )}
                {this.state.InsiderPermissions &&
                  this.state.InsiderPermissions.Edit && (
                    <Edit
                      ...
                      onClick={() =>
                        this.props.history.push({
                          pathname: `/app/ajgroup/HRM/HrmPractskill/PracticsEdit/${params.data?._id}`,
                          state: params.data,
                        })
                      }
                    />
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.desc ? params.data?.desc : "NA"}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.rightAnswer}</span>
                </div>
              </div>
            );
          },
  ...
  async Apicalling(id, db) {
    ...
    await _Get(Hrm_SkillList, db, id)
      .then((res) => {
        this.setState({ Loading: false });

        if (res?.Question) {
          this.setState({ rowData: res?.Question });
        }
        this.setState({ AllcolumnDefs: this.state.columnDefs });
        this.setState({ SelectedCols: this.state.columnDefs });

        let userHeading = JSON.parse(localStorage.getItem("PracticalList"));
  ...
  async componentDidMount() {
    const InsidePermissions = CheckPermission("Practice & Skills Test");
