...
class TermList extends React.Component {
      ...
      columnDefs: [
              ...
              <div className="actions cursor-pointer text-center">
                    ...
                    <Eye
                      ...
                      onClick={() =>
                        this.props.history.push({
                          pathname: `/app/ajgroup/HRM/HRMAdminForms/terminationVIEW/${params.data?._id}`,
                          state: params.data,
                        })
                      }
                    />
                ...
                {this.state.InsiderPermissions.Edit && (
                  <Edit
                    ...
                    onClick={() =>
                      this.props.history.push({
                        pathname: `/app/ajgroup/HRM/HRMAdminForms/terminationEDIT/${params.data?._id}`,
                        state: params.data,
                      })
                    }
                  />
        ...
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>{params.data?.terminationType}</div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.noticeDate}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.terminationDate}</span>
                </div>
              </div>
            );
          },
  ...
  async Apicalling(id, db) {
    ...
    await _Get(VIEW_TERMINATION, db, id)
      .then(res => {
        this.setState({ Loading: false });

        if (res?.Termination) {
          this.setState({ rowData: res?.Termination });
        }
        this.setState({ AllcolumnDefs: this.state.columnDefs });
        this.setState({ SelectedCols: this.state.columnDefs });

        let userHeading = JSON.parse(localStorage.getItem("Terminationlist"));
  ...
  async componentDidMount() {
    const InsidePermissions = CheckPermission("Termination");
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        onClick={() =>
                          history.push(
                            "/app/ajgroup/HRM/HRMAdminForms/termiForm"
                          )
                        }
                      >
