...
class GSTR1 extends React.Component {
  ...
  async Apicalling(id, db) {
    ...
    await PurchaseOrderList(id, db)
      .then(res => {
        ...
        let userHeading = JSON.parse(localStorage.getItem("GSTR2BList"));
  ...
  async componentDidMount() {
    ...
    const InsidePermissions = CheckPermission("GSTR 2B");
          ...
          <Row className="ml-2  mr-2">
            ...
            <Col xl="5" lg="5" md="5">
              <Row>
                ...
                <Col xl="2" lg="2" md="2" style={{ marginTop: "10px" }}>
            ...
            <Col xl="1" lg="1" md="1" style={{ marginTop: "25px" }}>
