...
class PurchaseReturnReport extends React.Component {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            ...
            return (
              <div className="cursor-pointer text-center">
                <span>{params?.data?.order?.orderId?.invoiceId}</span>
              </div>
            );
          },
        },
  ...
  async Apicalling(id, db) {
    ...
    await Purchase_ReturnList(id, db)
      .then(res => {
        ...
        let Alldata = res?.PurchaseReturn?.flatMap((element, index) => {
          return element?.returnItems?.map((val, i) => {
        ...
        let userHeading = JSON.parse(
          localStorage.getItem("PurchaseReturnReport")
        );
  ...
  async componentDidMount() {
    ...
    const InsidePermissions = CheckPermission("Purchase Return Report");
          ...
          <Row className="ml-2  mr-2">
            ...
            <Col md="5" xl="5" lg="5">
              <Row>
                ...
                <Col md="2" xl="2" lg="2" style={{ marginTop: "25px" }}>
