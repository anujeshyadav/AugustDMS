...
class SalesReturnReport extends React.Component {
  ...
  async Apicalling(id, db) {
    ...
    await SalesReturnProductList(id, db)
      .then(res => {
        ...
        let Alldata = res?.SalesReturn?.flatMap((element, index) => {
        ...
        let userHeading = JSON.parse(
          localStorage.getItem("Sales Return Report")
        );
      ...
      <>
        <Card>
          <Row className="ml-2  mr-2">
            ...
            <Col style={{ marginTop: "30px" }} xl="1" lg="1">
