...
class PurchaseOrderReport extends React.Component {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div>
                <span color="primary">{params?.data?.taxableAmount}</span>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div>
                <span color="primary">{params?.data?.cgstRate}</span>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div>
                <span color="primary">{params?.data?.sgstRate}</span>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div>
                <span color="primary">{params?.data?.igstRate}</span>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div>
                <span color="primary">{params?.data?.grandTotal}</span>
              </div>
            );
          },
        },
  ...
  async componentDidMount() {
    ...
    const InsidePermissions = CheckPermission("PURCHASE ORDER REPORT");
  ...
  downloadExcelFile(blob) {
    ...
    a.href = url;
    a.download = "PurchaseOrderReport.xlsx";
  ...
  convertCSVtoExcel = () => {
    ...
    Papa.parse(CsvData, {
      complete: (result) => {
        ...
        const excelType = "xls";
        XLSX.writeFile(wb, `PurchaseOrderReport.${excelType}`);
      },
    });
  };
        ...
        <Card>
          <Row className="ml-2  mr-2">
            ...
            {this.state.MasterShow && this.state.MasterShow ? (
              <Col style={{ marginTop: "25px" }} lg="2" md="2" xl="2">
                <SuperAdminUI
