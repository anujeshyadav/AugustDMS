...
class DeadPartyReport extends React.Component {
  ...
  async componentDidMount() {
    ...
    const InsidePermissions = CheckPermission("Dead Parties Reports");
...
export default DeadPartyReport;
