...
class purchasereportamount extends React.Component {
  ...
  async componentDidMount() {
    ...
    const InsidePermissions = CheckPermission("Lock Party Report");
      ...
      <>
        <Card>
          <Row className="ml-2 mr-2">
            ...
            <Col style={{ marginTop: "30px" }} xl="1" lg="1" md="1">
