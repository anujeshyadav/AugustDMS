...
class DamageStockReport extends React.Component {
        ...
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <>
                <div className="actions cursor-pointer text-center">
                  <span>{params?.data?.damage?.productId?.Product_MRP}</span>
                </div>
              </>
            );
          },
        },
        {
          ...
          cellRendererFramework: params => {
            let Amount =
              ...
              (params?.data?.damage?.productId?.GSTRate * 0.01);
            return (
              <>
                <div className="actions cursor-pointer text-center">
    ...
    await _Get(Create_Warehouse_List, db)
      .then(res => {
        ...
        if (damage?.length) {
          ...
          this.setState({ rowAllData: damage });
        }
  ...
  async componentDidMount() {
    ...
    const InsidePermissions = CheckPermission("Damage Reports");
