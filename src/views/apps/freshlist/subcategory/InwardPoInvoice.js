                        ...
                        <View
                          ...
                          <Text
                            ...
                            {InwardCondition && InwardCondition ? (
                              <>
                                {`${BilData?.ViewOneData?.warehouseFromId?.warehouseName}
                             ${BilData?.ViewOneData?.warehouseFromId?.address}`}
                              </>
                            ) : (
                              <>
                                {`${AllData?.CompanyDetails?.name}
                      ...
                      {UserChoice?.shipto == "Left" && (
                        <View
                          ...
                          <Text
                            ...
                            {`${BilData?.ViewOneData?.warehouseToId?.warehouseName}
                             ${BilData?.ViewOneData?.warehouseToId?.address}`}
                          </Text>{" "}
                          <Text
                            style={{
                              fontSize: "10px",
                            ...
                            {`${BilData?.ViewOneData?.warehouseToId?.warehouseName}
                             ${BilData?.ViewOneData?.warehouseToId?.address}`}
                            Mobile No:{" "}
                            {`${BilData?.ViewOneData?.warehouseToId?.mobileNo} `}
                          </Text>{" "}
                        </View>
                      )}
                    </View>
